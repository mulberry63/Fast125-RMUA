...
namespace my_planner
{
    ...
    protected:
        ...
        Eigen::VectorXd ts;
        Eigen::MatrixXd sta_vaj, end_vaj;
    ...
    private:
        ...
        std::pair<Eigen::VectorXd, Eigen::VectorXd> MinSnapCloseFormServer(const Eigen::VectorXd &wp, const Eigen::Vector3d &start_vaj, const Eigen::Vector3d &end_vaj);
    ...
    public:
        ...
        void set_end_state(const Eigen::MatrixXd &vaj);
